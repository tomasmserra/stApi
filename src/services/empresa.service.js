...
async function getProvincias() {
  ...
  const url = `${ghostUrl}/api/ambito/provincias`;
  try {
...
async function getLocalidades(idProvincia) {
  ...
  const url = `${ghostUrl}/api/ambito/localidades/${idProvincia}`;
  try {
    const response = await fetch(url, requestOptions);
    if (!response.ok) {
...
async function getDatosPrincipalesEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-principales/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
  try {
...
async function saveDatosPrincipalesEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-principales/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
  try {
    result = await response.json();
...
async function getDomicilioEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/domicilio/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveDomicilioEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/domicilio/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getDatosFiscalesEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-fiscales/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveDatosFiscalesEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-fiscales/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getDatosFiscalesExteriorEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-fiscales-exterior/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveDatosFiscalesExteriorEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-fiscales-exterior/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getDatosOrganizacionEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-empresa/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveDatosOrganizacionEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-empresa/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getDatosRegistroEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-registro/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveDatosRegistroEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/datos-registro/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getCuentasBancariasEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/cuentas-bancarias/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveCuentasBancariasEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/cuentas-bancarias/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getCuentasBancariasExteriorEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/cuentas-bancarias-exterior/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveCuentasBancariasExteriorEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/cuentas-bancarias-exterior/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getDeclaracionesEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/declaraciones/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveDeclaracionesEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/declaraciones/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getPerfilInversorEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/perfil-inversor/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function savePerfilInversorEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/perfil-inversor/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getDocumentacionRespaldatoriaEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/documentacion-respaldatoria/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveDocumentacionRespaldatoriaEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/documentacion-respaldatoria/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getTerminosCondicionesEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/terminos-condiciones/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function saveTerminosCondicionesEmpresa(datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/terminos-condiciones/${datos.solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getAccionistasEmpresa(solicitudId) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/accionistas/${solicitudId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function updateAccionistaEmpresa(solicitudId, accionistaId, datos) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/accionistas/${solicitudId}/${accionistaId}`;
  const response = await fetch(url, requestOptions);
  let result = {};
...
async function getAccionistaPorDocumento(solicitudId, numeroDocumento) {
  ...
  const url = `${ghostUrl}/api/empresa-apertura/accionistas/${solicitudId}/${numeroDocumento}`;
  const response = await fetch(url, requestOptions);
  let result = null;
