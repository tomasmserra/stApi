...
- **REACT_APP_API_URL**: URL del backend para autenticación, registro y validación
- **REACT_APP_GHOST_URL**: URL del backend para operaciones de apertura de cuenta (individuo y empresa)
